...
## 🌊 Key Values
- **사유의 보호 (Contemplation Protection)**: 지극히 개인적이고 깊은 사유의 과정을 외부의 소음으로부터 격리하고 온전히 보호합니다.
- **영혼의 세공 (Soul Refining)**: 에이전트 **'지미니(Jimini)'**가 던지는 날카롭고도 다정한 질문을 통해 당신의 잊혔던 진실을 마주합니다.
- **가치의 증명 (Value Proof)**: 당신의 본질을 솔직하게 직면할수록 $PoDR$ 지표는 상승하며, 이는 보석 토큰(SBT)과 $RESO 토큰으로 치환되어 당신의 가치를 증명합니다.
...
- **Glitch Effect & Dark Mode**: 수압이 느껴지는 심해의 분위기와 디지털 노이즈를 결합한 몰입형 UI.
...
---
Developed by **Antigravity Team** for the Deep-Resolution Project.
